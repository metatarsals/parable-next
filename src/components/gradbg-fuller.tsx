export default function GradientBackgroundFuller() {
    return (
        <div className="fixed -z-10 inset-0 overflow-hidden opacity-12">
            ...
            <div className="absolute inset-0">
                ...
                <div className="absolute top-1/2 left-1/3 w-[600px] h-[600px] bg-indigo-700 rounded-full blur-3xl [animation:blob_7s_infinite_4s,float_20s_ease-in-out_infinite_-10s]" />
